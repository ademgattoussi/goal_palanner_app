...
var ListKeyManager = class {
   ...
   */
  tabOut = new import_rxjs6.Subject();
...
var MatExpansionPanel = class _MatExpansionPanel extends CdkAccordionItem {
  ...
  _inputChanges = new import_rxjs14.Subject();
  ...
  ngAfterContentInit() {
    if (this._lazyContent && this._lazyContent._expansionPanel === this) {
      this.opened.pipe((0, import_operators7.startWith)(null), (0, import_operators7.filter)(() => this.expanded && !this._portal), (0, import_operators7.take)(1)).subscribe(() => {
...
var MatExpansionPanelHeader = class _MatExpansionPanelHeader {
  ...
  _focusMonitor = inject(FocusMonitor);
  _changeDetectorRef = inject(ChangeDetectorRef);
  _parentChangeSubscription = import_rxjs14.Subscription.EMPTY;
  constructor() {
    ...
    const accordionHideToggleChange = panel.accordion ? panel.accordion._stateChanges.pipe((0, import_operators7.filter)((changes) => !!(changes["hideToggle"] || changes["togglePosition"]))) : import_rxjs14.EMPTY;
    this.tabIndex = parseInt(tabIndex || "") || 0;
    this._parentChangeSubscription = (0, import_rxjs14.merge)(panel.opened, panel.closed, accordionHideToggleChange, panel._inputChanges.pipe((0, import_operators7.filter)((changes) => {
      return !!(changes["hideToggle"] || changes["disabled"] || changes["togglePosition"]);
    }))).subscribe(() => this._changeDetectorRef.markForCheck());
    panel.closed.pipe((0, import_operators7.filter)(() => panel._containsFocus())).subscribe(() => this._focusMonitor.focusVia(this._element, "program"));
    if (defaultOptions) {
...
var MatAccordion = class _MatAccordion extends CdkAccordion {
  ...
  ngAfterContentInit() {
    this._headers.changes.pipe((0, import_operators7.startWith)(this._headers)).subscribe((headers) => {
